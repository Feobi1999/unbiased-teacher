...
from ubteacher.data.dataset_mapper import DatasetMapperTwoCropSeparate,DatasetMapper_gt_test
...
class BaselineTrainer(DefaultTrainer):
    ...
    def train_loop(self, start_iter: int, max_iter: int):
        ...
        """
        logger = lFogging.getLogger(__name__)
    ...
    def run_step_full_semisup(self):
        ...
        if self.iter < self.cfg.SEMISUPNET.BURN_UP_STEP:
            ...
            if self.cfg.ADDITIONAL_BRANCH == 1:
                ...
                # data_to_contrast =label_data_q
                # record_dict, _, _, _ = self.model(data_to_contrast, branch="contrast_src_fft")
            ...
            if self.cfg.ADDITIONAL_BRANCH == 1:
                ...
                record_dict, _, _, _ = self.model(all_label_data, branch="contrast_supervised")
            ...
            if self.cfg.ADDITIONAL_BRANCH == 4:
            #contrast between fft & tgt
                all_contrast_data = label_data_k + unlabel_data_k
