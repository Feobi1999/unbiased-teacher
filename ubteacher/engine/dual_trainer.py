...
class BaselineTrainer(DefaultTrainer):
    ...
    def build_test_loader(cls, cfg, dataset_name):
        ...
        Returns:
            iterable
        """
        return build_detection_semisup_test_loader(cfg, dataset_name)
        ...
        if self.iter < self.cfg.SEMISUPNET.BURN_UP_STEP:
            ...
            with torch.no_grad():
                (
                    ...
                    _,
                ) = self.model_teacher(unlabel_data_k,label_data_k, branch="unsup_data_weak",domain_stats='s_to_t')
            ...
            record_all_label_data, _, _, _ = self.model(
                all_label_data, all_label_data, branch="supervised"
            )
