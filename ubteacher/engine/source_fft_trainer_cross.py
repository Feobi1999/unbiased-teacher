...
class UBTeacherTrainer(DefaultTrainer):
    ...
    def run_step_full_semisup(self):
        ...
        # print("unlabel data length", len(unlabel_data_k))
        ...
        if self.iter < self.cfg.SEMISUPNET.BURN_UP_STEP:
            ...
            record_all_label_data_cross, _, _, _ = self.model(
                all_label_data, branch="supervised_cross"
            )

            new_record_all_label_data_cross= {}
            for key in record_all_label_data_cross.keys():
                new_record_all_label_data_cross[key + "_cross"] = record_all_label_data_cross[
                    key
                ]


            record_dict.update(new_record_all_label_data_cross)
