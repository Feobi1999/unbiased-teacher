...
from detectron2.evaluation import verify_results,COCOEvaluator
...
class BaselineTrainer(DefaultTrainer):
    ...
    #         results = list(results.values())[0]
        ...
        #     os.makedirs(path)
        # # f1 = open('%s/%s_bbox_feature.pkl'%(path,dataset_name), 'wb')
        # # f2 = open('%s/%s_bbox_prediction.pkl'%(path,dataset_name), 'wb')
        # # f3 = open('%s/%s_bbox_score.pkl'%(path,dataset_name), 'wb')
        # # f4 = open('%s/%s_image_level_feature.pkl'%(path,dataset_name), 'wb')
        # # pickle.dump(feature_to_save, f1)
        # # pickle.dump(pred_cls,f2)
        # # pickle.dump(pred_score,f3)
        # # pickle.dump(img_feature,f4)
        #
        # print("saved")
...
class UBTeacherTrainer(DefaultTrainer):
    ...
    #     import pickle
        ...
        # path='sim10k_fft_normtrain_714_gt_pooling'
        # if not os.path.exists(path):
        #     os.makedirs(path)
        # # path='sim10k_sourceonly_vis'
        # # path='source_only_vis'
        #
        # f1 = open('%s/%s_bbox_feature.pkl'%(path,dataset_name), 'wb')
        # f2 = open('%s/%s_bbox_prediction.pkl'%(path,dataset_name), 'wb')
        # f3 = open('%s/%s_bbox_score.pkl'%(path,dataset_name), 'wb')
