...
class TwoStagePseudoLabGeneralizedRCNN(GeneralizedRCNN):
    ...
    #     print(kwargs)
    #     super(TwoStagePseudoLabGeneralizedRCNN, self).__init__(**kwargs)
    #
    #     super().__init__()

    # da_img_heads = build_img_da_heads()
    ...
    def forward(
        ...
        if branch == "supervised":
            ...
            img_head= build_img_da_heads()()
            da_losses = img_head(features,domain_label )
            return da_losses
